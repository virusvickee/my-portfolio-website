export const projectsData = [
  {
    ...
    category: "Full Stack",
    tags: ["React", "TypeScript", "Vite", "Tailwind CSS", "Radix UI", "React Router", "React Hook Form", "Recharts", "Framer Motion", "Zod"],
    github: "https://github.com/virusvickee/verve-social",
    demo: "https://verve-social.vercel.app/",
    featured: true,
    status: "completed",
    year: 2024,
    highlights: [
  ...
  },
  {
    ...
    demo: "https://fresh-hub-hero-ah4byf8mw-virusvickees-projects.vercel.app/",
    featured: true,
    status: "completed",
    year: 2024,
    highlights: [
  ...
  },
  {
    ...
    category: "Full Stack",
    tags: ["React", "Node.js", "Express.js", "MongoDB", "Chart.js", "Material-UI", "JWT"],
    github: "https://github.com/virusvickee/college-management",
    demo: "https://principal-s-command-center.vercel.app/",
    featured: true,
    status: "completed",
    year: 2024,
    highlights: [
  ...
  },
  {
    ...
    image: "/image.png",
    category: "Automation",
    tags: ["n8n", "Google Gemini AI", "Gmail", "Notion", "Google Sheets", "Slack"],
  ...
  },
  {
    ...
    category: "Web App",
    tags: ["React", "Python", "TensorFlow", "Firebase", "OpenAI API", "Chart.js", "PWA"],
    github: "https://github.com/virusvickee/ai-habit-tracker",
    demo: "https://ai-habit-coach-nine.vercel.app/",
    featured: true,
    status: "completed",
    year: 2023,
    highlights: [
  ...
  },
  {
    ...
    category: "Dashboard",
    tags: ["React", "Node.js", "PostgreSQL", "Python", "Docker", "AWS", "Redis"],
  ...
  },
  {
    ...
    category: "Web App",
    tags: ["React", "Node.js", "MongoDB", "OpenAI API", "Google Maps API", "Stripe"],
    github: "https://github.com/virusvickee/ai-travel-planner",
    demo: "https://ai-travel-companion-eta.vercel.app/",
    featured: true,
    status: "completed",
    year: 2024,
    highlights: [
  ...
  },
  {
    ...
    category: "Web App",
    tags: ["React", "Tailwind CSS", "Framer Motion", "Vite", "Netlify", "EmailJS"],
    github: "https://github.com/virusvickee/my-portfolio-website",
    demo: "https://vikasuniyal.com",
    featured: true,
    status: "completed",
    year: 2024,
    highlights: [
...
export const categories = ["All", "Full Stack", "Web App", "Dashboard", "Automation"]
